...
public class TC016_MyItineraryButton extends ProjectSpecificationMethods{
	...
	public void setup() throws IOException {
	 ...
	 @Test
		public void testMyItineraryButton() {
		 
		 BookingConfirmationPage obj4 = new BookingConfirmationPage(driver);
		 obj4.clickMyItineraryButton();
			
			Assert.assertTrue(driver.getCurrentUrl().contains("BookedItinerary"), "TC016(Fail) - User didn't navigate to My Itinerary page");
			System.out.println("TC016(Pass) - User navigated to My Itinerary page successfully");
