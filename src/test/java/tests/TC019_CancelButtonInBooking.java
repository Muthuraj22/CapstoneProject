...
public class TC019_CancelButtonInBooking extends ProjectSpecificationMethods{
	...
	public void setup() throws IOException {
	 ...
	 @Test
	 public void verifyCancelButtonsPresent() {
	     List<WebElement> cancelButtons = driver.findElements(By.xpath("//input[contains(@value, 'Cancel')]"));
	     for (WebElement button : cancelButtons) {
	         Assert.assertTrue(button.isDisplayed(), "TC019(Fail) - Cancel button not displayed");
	         System.out.println("TC019(Pass) - Cancel button displayed");
	     }
	 }
